...
credentials = credentials.ApplicationDefault() # Creamos la credencial para conectarnos
...
def get_todos(user_id):
    """Metodo para obtener los todos del usuario"""
    return db.collection('users').document(user_id).collection('todos').get()


def put_todos(user_id, description):
    """Este metodo crear todos con un random ID"""
